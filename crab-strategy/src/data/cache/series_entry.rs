...
pub struct SeriesEntry {
    ...
    state: AtomicU8,     // 0=Uninit,1=Loading,2=Ready
    notify: Arc<Notify>, // notify waiters when ready
}
impl SeriesEntry {
    pub fn new_empty() -> Self {
        // create empty series with name placeholder
        let builder = BaseBarSeriesBuilder::<DecimalNum>::new().with_name("empty".into());
